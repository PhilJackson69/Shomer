# Shomer v1.0.0 — Stable Production Release
...
- **Audit Manifest:** [AUDIT_MANIFEST.sha256](releases/v1.0.0/AUDIT_MANIFEST.sha256)
- **Stability Certificate:** [STABILITY_CERTIFICATE.md](releases/v1.0.0/STABILITY_CERTIFICATE.md)
- **Final Audit Sign-off:** [FINAL_AUDIT_SIGNOFF.md](releases/v1.0.0/FINAL_AUDIT_SIGNOFF.md)
- **Immutable Archive:** `audit-archive-20251018.tar.gz` with SHA256 verification
